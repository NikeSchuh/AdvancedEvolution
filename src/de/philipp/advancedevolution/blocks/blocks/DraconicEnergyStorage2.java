...
public class DraconicEnergyStorage2 extends DraconicMachineBase {

    private List<Block> receivers = new ArrayList<>();
    private final double maxTransfer = 25000;
    ...
    public void onPlace(DraconicBlock block, Cancellable cancellable, Player player) {
        ...
        crystalLinkManager.createCrystalData(32);
    }
    ...
    public EnhancedRecipe getCraftingRecipe() {
        ...
        recipe.addIngredient(new DraconicIngredient("DraconicEnergyStorage1", 4));
        recipe.addIngredient(new DraconicIngredient("WyvernCore", 1));
        return recipe;
    }
    ...
    public boolean sendEnergy(DraconicMachine receiver, DraconicMachine sender, double amount, BlockFace face) {
        ...
        if(receiver.isEnergyAcceptable() && sender.isEnergyPullAble()) {
            new EnergyOrb(AdvancedEvolution.getInstance(), receiver, sender, amount, face, distance / 5) {
                @Override
    ...
    public String getDataName() {
        return "DraconicEnergyStorage2";
    }

    @Override
    public ItemStack getBaseStack() {
        return ItemUtil.createSimpleStack("§cEnergy Storage II", XMaterial.BARREL);
    }
