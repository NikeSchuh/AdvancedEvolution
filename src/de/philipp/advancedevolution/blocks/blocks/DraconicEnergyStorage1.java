...
public class DraconicEnergyStorage1 extends DraconicMachineBase {

    private List<Block> receivers = new ArrayList<>();
    private final double maxTransfer = 5000;
    ...
    public EnhancedRecipe getCraftingRecipe() {
        ...
        recipe.addIngredient(new DraconicIngredient("DraconicCore", 2));
        return recipe;
    }
    ...
    public boolean sendEnergy(DraconicMachine receiver, DraconicMachine sender, double amount, BlockFace face) {
        ...
        if(receiver.isEnergyAcceptable() && sender.isEnergyPullAble()) {
            new EnergyOrb(AdvancedEvolution.getInstance(), receiver, sender, amount, face, distance / 10) {
                @Override
    ...
    public String getDataName() {
        return "DraconicEnergyStorage1";
    }

    @Override
    public ItemStack getBaseStack() {
        return ItemUtil.createSimpleStack("§cEnergy Storage I", XMaterial.BARREL);
    }
