...
public class DraconicEnergyStorageCreative extends DraconicMachineBase {

    private List<Block> receivers = new ArrayList<>();
    private final double maxTransfer = 1000000000d;
    ...
    public void onPlace(DraconicBlock block, Cancellable cancellable, Player player) {
        ...
        crystalLinkManager.createCrystalData(256);
    }
    ...
    public String getDataName() {
        return "DraconicEnergyStorageCreative";
    }

    @Override
    public ItemStack getBaseStack() {
        return ItemUtil.createSimpleStack("§cCreative Energy Storage", XMaterial.BARREL);
    }
