...
public abstract class ParticleVelocityChasing extends ParticleEntityVelocity implements ICollisionEntity {
    ...
    public ParticleVelocityChasing(Plugin plugin, Location startLoc, Entity target, Vector speed, double maxSpeed, Hitbox hitbox) {
        super(plugin, startLoc, speed);
        this.target = target;
        this.speed = speed;
        this.hitbox = hitbox;
